...
public class HoneycombBackdrop : Control
{
    ...
    const byte LineAlpha = 12;  // accent line transparency (regardless of source brush)
    const byte ShadowAlpha = 16; // dark "shadow" line, offset 1px, for a subtle 3D/embossed look
