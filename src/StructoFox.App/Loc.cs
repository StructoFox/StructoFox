...
public static class Loc
{
    ...
    static readonly Dictionary<string, string> En = new()
    {
        ...
        ["Code_AddTextTip"]       = "Add text: a single-line label or a multi-line rich text box (same editor as the print canvas)",
        ["Code_NewText"]          = "Text",
    ...
    static readonly Dictionary<string, string> De = new()
    {
        ...
        ["Code_AddTextTip"]       = "Text hinzufügen: einzeilige Beschriftung oder mehrzeilige Rich-Text-Box (derselbe Editor wie im Print-Canvas)",
        ["Code_NewText"]          = "Text",
        ["Code_NewLineText"]      = "Text",
